...
const Dashboard = () => {
  ...
  return (
    <div className="bg-[#030712] min-h-screen text-white p-8 font-sans">
      {/* Inject SEO Tags for Dashboard */}
      <Helmet>
        <title>Cognitive Resonance Report | MindPulse Dashboard</title>
        <meta name="description" content="View your private, encrypted cognitive resonance report and stress metrics generated by your MindPulse session." />
      </Helmet>
